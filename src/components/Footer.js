...
import logo from '../images/logo-bookmarkWhite.svg'
...
function Footer() {
    return (
        <footer class="w-full md:h-16 bg-veryDarkBlue text-white flex flex-col md:flex-row flex-wrap justify-center relative md:justify-between  items-center px-2  md:px-32 md:py-5 py-8 text-center bottom-0">
            ...
            <a  class="text-l  font-bold leading-relaxed inline-block mr-4 py-2  uppercase w-full md:w-max flex items-center justify-center bg-veryDarkBlue " href= "#">
                <img src={logo} class=""/>
                    </a>
